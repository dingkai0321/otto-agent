...
from otto.ops.dashboard import collect, events_since
from otto.ops.tracing import TraceEncodingError, Tracer
...
def test_dashboard_ops_view_surfaces_trace_encoding_errors():
    views = (
        Path(__file__).resolve().parents[2] / "otto" / "ops" / "static" / "js" / "views.js"
