"""`python -m otto.ops.show_trace` — read a JSONL trace as a terminal timeline.

Pass a trace file directly, or omit it to show the most recent trace in OTTO_HOME
(the current directory's .otto/ by default). Trace records are printed one at a
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Render a Otto JSONL trace as a terminal timeline."
    )
    parser.add_argument(
